...
public interface SectionService {
    ...
    boolean addSection(String sectionName, int teacherId, int partId, int sort, String type, String introduction, int courseId) throws SQLException, InterruptedException;
